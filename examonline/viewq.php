...
<body
    style=" margin: 0 !important;font-weight: bold !important; font-family: 'Courier New', Courier, monospace;color:black;height:auto;">
    <div style="background-color: #B0DAD0; height: auto; ">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            <section class="h-font" style="margin: 1.5vw;">QUIZMASTER-HUB</section>
            <ul
                style="display: inline-flex;padding: 0 !important;margin: 0;float: right;right: 0;position: fixed;width: 50vw;">
                <li class="google-font fw-blod" onclick="dash()">Dashbord</li>
                <li class="google-font fw-blod" onclick="prof()">profile</li>
                <li class="google-font fw-blod" onclick="score()">Quiz's</li>
                <li class="google-font fw-blod" onclick="lo()">Sign Out</li>
            </ul>
        </div><br><br>
