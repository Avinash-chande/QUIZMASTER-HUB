...
<body style="margin:0;height:100%;outline: none;color: #042A38 !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/exammm.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height:auto;padding-bottom: 5vw;">
        <center>
            <h1 class ="h-font" style=" color:#042A38;text-transform: uppercase;width: auto;background:#fff;padding: 1vw;"> QUIZMASTER-HUB</h1>
        </center>
        <center>
            <div class="login">
                <div id="getcode" style="display: initial">
                    <form method="POST">
                        ...
                        <div class="signin">
                            ...
                            <br><br>
                            <input name="submit" class="sub" type="submit" value="Get the Code" style="height: 2vw;width: 10vw;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                    </form><br><br>
                </div>
